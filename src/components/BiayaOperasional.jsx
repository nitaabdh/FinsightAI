    ...
    <div className="biayaops">
      <div className="biayaops__form">
        ...
        <div className="biayaops__form-actions">
          {editId && <button className="biayaops__btn-sec" onClick={resetForm}>Batal</button>}
      ...
      <div className="biayaops__list">
        <h3 className="biayaops__list-title">Daftar Biaya Operasional</h3>
        {opsList.length === 0 ? (
