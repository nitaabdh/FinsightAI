...
import { ASET_KEY, loadData, saveData, genId, formatRupiah } from "../utils/umkmCalc";
...
export default function AsetUsaha() {
  ...
  const persist = (updated) => {
    setList(updated);
    saveData(ASET_KEY(user.id), updated);
  };
  ...
  // ... validasi sama ...
  const payload = { id: genId(), ...payloadData };
  if (editId) {
    const r = await apiFetch(`/api/umkm?table=aset_usaha`, { method: "PUT", body: JSON.stringify({ id: editId, ...payloadData }) });
    if (r.success) setList(p => p.map(it => it.id === editId ? r.data : it));
  } else {
    const r = await apiFetch(`/api/umkm?table=aset_usaha`, { method: "POST", body: JSON.stringify(payload) });
 ...
 const handleDel = async (id) => {
  ...
  // ── Daftar kategori yang sudah pernah dipakai (preset + custom yang ada di data) ──
    ...
    <div className="asetusaha">
      ...
      <div className="asetusaha__form">
        ...
        <div className="asetusaha__grid">
          <div className="asetusaha__field asetusaha__field--wide">
            ...
            <input
              className="asetusaha__input" type="text" name="nama"
          ...
          {form.kategori === "lainnya" && (
            <div className="asetusaha__field">
              ...
              <input
                className="asetusaha__input" type="text" name="kategoriCustom"
          ...
          <div className="asetusaha__field">
            ...
            <input
              className="asetusaha__input" type="date" name="tanggalBeli"
          ...
          <div className="asetusaha__field">
            ...
            <input
              className="asetusaha__input" type="number" name="hargaBeli"
        ...
        <div className="asetusaha__field">
          ...
          <input
            className="asetusaha__input" type="text" name="catatan"
            placeholder="Misal: dibeli bekas dari toko sebelah"
      ...
      <div className="asetusaha__list">
        {list.length === 0 ? (
          ...
          <div className="asetusaha__empty">
            <p>🔍</p>
            <p>Tidak ada aset yang cocok dengan filter.</p>
          </div>
        ) : (
          filtered.map((it) => (
